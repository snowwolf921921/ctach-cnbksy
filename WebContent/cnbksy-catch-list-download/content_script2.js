...
//	data.pageDispalyText +=Number(totalNo)+"."+row.text;
	var msgItemInfo = {};
	msgItemInfo.type = "current-download-item-info";
	msgItemInfo.itemTrInfo = itemTrInfo.text;
	msgItemInfo.totalInfoAndCurrentDownloadInfo=totalInfoAndCurrentDownloadInfo;
